...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 380, 380, 503, 503, 655, 655,  798,  798,  902,  902,  960,  1000, 1100, 1200, 1320),
	CPU_DVFS("cpu", 1, 1, MHZ, 389, 389, 503, 503, 655, 760,  798,  798,  950,  950,  1000, 1100, 1200, 1320),
	CPU_DVFS("cpu", 1, 2, MHZ, 598, 598, 750, 750, 893, 893,  1000, 1100, 1200, 1320),
	CPU_DVFS("cpu", 1, 3, MHZ, 730, 760, 845, 845, 940, 1000, 1100, 1200, 1320),
	...
	CORE_DVFS("emc",     -1, 1, KHZ, 57000,  333000, 380000, 666000, 666000, 666000, 660000),
	...
	CORE_DVFS("epp",     -1, 1, KHZ, 133000, 171000, 247000, 400000, 400000, 400000, 400000),
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 400000, 400000, 400000, 400000),

	CORE_DVFS("3d",       0, 1, KHZ, 114000, 161500, 247000, 400000, 400000, 400000, 400000),
	CORE_DVFS("3d",       1, 1, KHZ, 161500, 209000, 285000, 400000, 400000, 400000, 400000),
	CORE_DVFS("3d",       2, 1, KHZ, 218500, 256500, 323000, 400000, 400000, 400000, 400000),
	CORE_DVFS("3d",       3, 1, KHZ, 247000, 285000, 351500, 400000, 400000, 400000, 400000),

	CORE_DVFS("mpe",      0, 1, KHZ, 104500, 152000, 228000, 400000, 400000, 400000, 400000),
	CORE_DVFS("mpe",      1, 1, KHZ, 142500, 190000, 275500, 400000, 400000, 400000, 400000),
	CORE_DVFS("mpe",      2, 1, KHZ, 190000, 237500, 300000, 400000, 400000, 400000, 400000),
	CORE_DVFS("mpe",      3, 1, KHZ, 228000, 266000, 300000, 400000, 400000, 400000, 400000),
	...
	CORE_DVFS("sclk",     1, 1, KHZ, 123500, 159500, 207000, 240000, 240000, 300000, 300000),
	...
	CORE_DVFS("vde",      0, 1, KHZ, 95000,  123500, 209000, 400000, 400000, 400000, 400000),
	CORE_DVFS("vde",      1, 1, KHZ, 123500, 152000, 237500, 400000, 400000, 400000, 400000),
	CORE_DVFS("vde",      2, 1, KHZ, 152000, 209000, 285000, 400000, 400000, 400000, 400000),
	CORE_DVFS("vde",      3, 1, KHZ, 171000, 218500, 300000, 400000, 400000, 400000, 400000),
	/* What is this? */
