...
static struct clk_pll_freq_table tegra_pll_x_freq_table[] = {
	...
	//  ( c / d ) x a = b
	//  ca / d = b
	//  c = b x d / a = 920/9 * 1300 = 132888 (nearest)
	/* 1.33 GHz */
	//{ 12000000, 1330000000, 665,  6,  1, 12},
	//{ 13000000, 1330000000, 920,  9,  1, 12},
...
static struct tegra_sku_rate_limit sku_limits[] =
{
	...
	RATE_LIMIT("cpu",	1320000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("cclk",	1320000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("pll_x",	1320000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
