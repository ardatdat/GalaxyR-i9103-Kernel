...
#define MAX224_FAMILYID                               0x80/*0x80*/
#define MAX224E_FAMILYID                               0x81/*0x80*/
...
#define MXT_PROCI_GRIPFACESUPPRESSION_T20             20u
...
struct mxt_platform_data {
	...
	const u8 **config_224;	/* for mxt224 */
	const u8 **config_224E;	/* for mxt224E */
