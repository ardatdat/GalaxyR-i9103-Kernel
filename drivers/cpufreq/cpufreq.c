...
#define FREQCOUNT 10
#define CPUMVMAX 1225
#define CPUMVMIN 750
int cpufrequency[FREQCOUNT] = { 1300000, 1200000, 1000000, 912000, 816000, 760000, 608000, 456000, 312000, 216000 };
int cpuvoltage[FREQCOUNT] = { 1225, 1225, 1100, 1050, 1000, 975, 900, 825, 775, 750 };
