...
#define CPUMVMIN 750
int cpufrequency[FREQCOUNT] = { 1350000, 1200000, 1000000, 912000, 816000, 760000, 608000, 456000, 312000, 216000 };
int cpuvoltage[FREQCOUNT] = { 1250, 1225, 1100, 1050, 1000, 975, 900, 825, 775, 750 };
