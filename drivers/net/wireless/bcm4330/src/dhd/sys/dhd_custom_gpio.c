...
extern int n1_device_wifi_power(int on, int flag);
#endif
...
dhd_customer_gpio_wlan_ctrl(int onoff)
{
	switch (onoff) {
		case WLAN_RESET_OFF:
			...
			n1_device_wifi_power (POWER_OFF, 2);
#endif
...
#elif defined(CONFIG_MACH_N1)
			n1_device_wifi_power (POWER_ON, 2);
#endif
...
#elif defined(CONFIG_MACH_N1)
			n1_device_wifi_power(POWER_OFF, 1);
...
#elif defined(CONFIG_MACH_N1)
			n1_device_wifi_power(POWER_ON, 1);
#elif defined(CONFIG_MACH_GODIN)
			godin_wifi_power(1);
			OSL_DELAY(150);
