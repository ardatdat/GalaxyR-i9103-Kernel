...
#define T38_USERDATA3             20	/* max touch for palm recovery  */
...
#define T8_CHRGTIME               10//36      /* 6 - 60  * 83 ns */
#define T8_ATCHDRIFT              0
#define T8_TCHDRIFT               5//20
#define T8_DRIFTST                0//20
#define T8_TCHAUTOCAL             0
#define T8_SYNC                   0
#define T8_ATCHCALST              9//10
#define T8_ATCHCALSTHR            30//10
#else
...
#define T8_TCHAUTOCAL             0
#define T8_SYNC                   0
#define T8_ATCHCALST			250
#define T8_ATCHCALSTHR		8
...
#define T9_MOVFILTER              0x20
#define T9_NUMTOUCH               5	    
#define T9_MRGHYST                20
#define T9_MRGTHR                 150
...
#define T9_JUMPLIMIT              40
#define T9_TCHHYST                25	 /* V2.0 or MXT224E added */
...
#define T46_IDLESYNCSPERX         11
#define T46_ACTVSYNCSPERX         19
...
#define	T48_TCHTHR                  35
#define	T48_TCHDI                   2
#define	T48_MOVHYSTI                3
#define	T48_MOVHYSTN                3
#define	T48_MOVFILTER             0x20
