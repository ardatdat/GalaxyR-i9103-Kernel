#ifndef __C1_CYPRESS_GPIO_H__
#define __C1_CYPRESS_GPIO_H__

#if defined (CONFIG_MACH_C1_REV00PRE) || defined (CONFIG_MACH_C1_REV01PRE) \
	|| defined (CONFIG_MACH_C1_REV00)
...
#define IRQ_TOUCH_INT		TEGRA_GPIO_TO_IRQ(GPIO_TKEY_INT)
