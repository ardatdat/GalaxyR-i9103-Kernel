...
#ifdef CONFIG_MACH_SAMSUNG_P4LTE
static void mc_control_active_state(int val)
{
	gpio_set_value(GPIO_AP2LTE_STATUS, val ? 1 : 0);
}
static int mc_get_active_state(void)
{
	return gpio_get_value(GPIO_AP2LTE_STATUS);
}
#endif
static
